...
def populateData():
	...
	regexDict = {'{pwm_diff_usec}':'pwmUpMaxTimeDiff:([0-9]+.[0-9]+)','{dutyCycle}':'Duty\ Cycle:([0-9]+.[0-9]+)','{pwmUptime}':'pwmUpTime:([0-9]+.[0-9]+)','{pwm_freq}':'PWM\ FREQ:([0-9]+)','{max_pwm_usec}':'MAX\ PWM\ uptime:([0-9]+.[0-9]*)','{reset_cycles}':'Resetting\ after\ every:([0-9]+)\ cycles','{sens1_value}':'Sensor\ 1\ Val:([0-9]+)','{sens1_voltage}':'Sensor\ 1\ Voltage\ Output:([0-9]+.[0-9]+)','{sens1_resistance}':'Sensor\ 1\ Resistance:([0-9]+.[0-9]+)','{sens1}':'Sensor\ 1\ Temperature:([0-9]+.[0-9]+)','{sens2_value}':'Sensor\ 2\ Val:([0-9]+)','{sens2_voltage}':'Sensor\ 2\ Voltage\ Output:([0-9]+.[0-9]+)','{sens2_resistance}':'Sensor\ 2\ Resistance:([0-9]+.[0-9]+)','{sens2}':'Sensor\ 2\ Temperature:([0-9]+.[0-9]+)','{sens3_value}':'Sensor\ 3\ Val:([0-9]+)','{sens3_voltage}':'Sensor\ 3\ Voltage\ Output:([0-9]+.[0-9]+)','{sens3_resistance}':'Sensor\ 3\ Resistance:([0-9]+.[0-9]+)','{sens3}':'Sensor\ 3\ Temperature:([0-9]+.[0-9]+)','{temp_avg}':'AVG:([0-9]+.[0-9]+)','{temp_stdev}':'STDEV:([0-9]+.[0-9]+)'}
